                                ...
                                <section class="text-gray-400">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-lg-6 text-end p-1">
                                            <a class="btn button text-white" style="background-color: rgb(5, 40, 132)" href="/tickets/create"
                                                id="createTicketButton">+ Create Pass</a>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                @forelse ($tickets as $ticket)
                                                    <tr>
                                                        ...
                                                        <td>{{ $ticket->status }}</td>
                                                        <td>
                                                            <a href="/tickets/edit/{{ $ticket->id }}" class="btn btn-success btn-sm">
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="5" class="text-center">No Pass available</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
    ...
    fetch(`/tickets/filter/${eventId}`)
        ...
        .then(tickets => {
            ...
            if (tickets.length === 0) {
                ticketsTableBody.innerHTML = `
                    <tr>
                        <td colspan="5" class="text-center">No tickets available for this event</td>
                    </tr>
                `;
            } else {
