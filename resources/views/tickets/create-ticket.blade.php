                                ...
                                <section class="text-gray-400">
                                    <div class="col-sm-6">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">Create Pass</li>
                                        </ol>
                                    </div>
                                    <form method="POST" action="{{ route('tickets.store') }}">
                                        ...
                                        {{-- <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control select-group" name="group_id" style="width: 100% !important">
                                                    <option value="select-all">Select Group</option>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control select-event" name="eventId" style="width: 100% !important">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.select-members').select2({
                placeholder: "Select Group to Send tickets",
                allowClear: true
            });
