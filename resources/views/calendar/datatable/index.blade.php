            ...
            <div class="card rounded">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        <small><i class="bi bi-info-circle"></i> Manage and organize your events</small>
                    </p>
                </div>
                <div class="card-body">
                    <!-- Breadcrumb -->
                    ...
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-end gap-2">
                            ...
                            <a href="/event-list/create" class="btn btn-primary btn-sm">
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log('DOM loaded, initializing events table');
    ...
    window.exportToExcel = function() {
        ...
        // Headers
        const headers = ['Event Name', 'Start', 'End', 'Address', 'Status'];
        data.push(headers);
        ...
        const fileName = 'Events_' + formattedDate + '.xlsx';
