  ...
  <a href="{{ route('panelIndex') }}" class="navbar-brand">
    ...
    <div class="logo-main">
      ...
      <div class="logo-normal">
        <img class="img logo" src="{{ asset('assets/linkstack/images/'.findFile('avatar')) }}" style="width:auto;height:80px;">
      </div>
      <div class="logo-mini">
        <img class="img logo" src="{{ asset('assets/linkstack/images/'.findFile('avatar')) }}" style="width:80%;height:30px;">
      </div>
      @else
      <div class="logo-normal">
...
<style>
/* Show normal logo by default, hide mini */
.logo-normal {
...
/* When sidebar is mini, show mini logo and hide normal */
...
/* ALSO handle when sidebar has these specific states */
.sidebar.sidebar-hover .logo-normal,
.sidebar[style*="margin-left"] .logo-normal {
  display: none !important;
}
.sidebar.sidebar-hover .logo-mini,
.sidebar[style*="margin-left"] .logo-mini {
  display: block !important;
}
</style>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
      <div class="sidebar-list">
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#events-collapse" role="button" aria-expanded="false" aria-controls="utilities-error">
              <i class="icon">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul class="sub-nav collapse" id="events-collapse" data-bs-parent="#sidebar-menu">
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link {{ Request::segment(2) == 'groups' ? 'active' : ''}}" href="{{ url('admin/groups') }}">
                  <i class="bi bi-people-fill"></i>
                  <span class="item-name">Manage Groups</span>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#utilities-error" role="button" aria-expanded="false" aria-controls="utilities-error">
              ...
              <span class="item-name">{{__('messages.Events')}}</span>
              <i class="right-icon">
                <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
            ...
            <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
              <li class="nav-item">
                <a class="nav-link {{ Request::segment(2) == 'event-calendar' ? 'active' : ''}}" href="{{ url('event-calendar') }}">
                  <i class="bi bi-calendar-event-fill"></i>
                  <span class="item-name">{{__('messages.Event Calendar')}}</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ Request::segment(2) == 'event-list' ? 'active' : ''}}" href="{{ url('event-list') }}">
                  <i class="bi bi-table"></i>
                  <span class="item-name">Event List</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ Request::segment(2) == 'event-list' ? 'active' : ''}}" href="{{ url('event-tables') }}">
                  <i class="bi bi-table"></i>
                  <span class="item-name">Seat Management</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ Request::segment(2) == 'tickets' ? 'active' : ''}}" href="{{ url('tickets') }}">
                  <i class="bi bi-ticket-detailed-fill"></i>
                  <span class="item-name">Pass</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ Request::segment(2) == 'discounts' ? 'active' : ''}}" href="{{ url('discounts') }}">
                  <i class="bi bi-tags-fill"></i>
                  <span class="item-name">Discount</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ Request::segment(2) == 'invoice' ? 'active' : ''}}" href="{{ url('invoice') }}">
                  <i class="bi bi-receipt-cutoff"></i>
                  <span class="item-name">Order</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ Request::segment(2) == 'invoice-logs' ? 'active' : ''}}" href="{{ url('/invoice/logs') }}">
                  <i class="bi bi-journal-bookmark-fill"></i>
                  <span class="item-name">Invoice Logs</span>
                </a>
              </li>
              {{-- <li class="nav-item">
                          <a class="nav-link {{ Request::segment(2) == 'attendance' ? 'active' : ''}}" href="{{ url('attendee') }}">
              <i class="bi bi-people-fill"></i>
              <span class="item-name">Attendee List</span>
              </a>
          </li> --}}

          <li class="nav-item">
            <a class="nav-link {{ Request::segment(2) == 'guest-tickets' ? 'active' : ''}}" href="{{ url('guest-tickets') }}">
              <i class="bi bi-person-badge-fill"></i>
              <span class="item-name">Guest Pass</span>
            </a>
          </li>
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#food-service-menu" role="button" aria-expanded="false" aria-controls="food-service-menu">
            <i class="icon">
              <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.5 2C8.5 1.44772 8.05228 1 7.5 1C6.94772 1 6.5 1.44772 6.5 2V10C6.5 11.1046 7.39543 12 8.5 12C9.60457 12 10.5 11.1046 10.5 10V2C10.5 1.44772 10.0523 1 9.5 1C8.94772 1 8.5 1.44772 8.5 2Z" fill="currentColor" />
                <path d="M8.5 13C7.94772 13 7.5 13.4477 7.5 14V22C7.5 22.5523 7.94772 23 8.5 23C9.05228 23 9.5 22.5523 9.5 22V14C9.5 13.4477 9.05228 13 8.5 13Z" fill="currentColor" />
                <path d="M12.5 2C12.5 1.44772 12.9477 1 13.5 1C14.0523 1 14.5 1.44772 14.5 2V5C14.5 6.10457 15.3954 7 16.5 7C17.6046 7 18.5 6.10457 18.5 5V2C18.5 1.44772 18.9477 1 19.5 1C20.0523 1 20.5 1.44772 20.5 2V5C20.5 7.20914 18.7091 9 16.5 9C14.2909 9 12.5 7.20914 12.5 5V2Z" fill="currentColor" />
                <path d="M15.5 10C14.9477 10 14.5 10.4477 14.5 11V22C14.5 22.5523 14.9477 23 15.5 23C16.0523 23 16.5 22.5523 16.5 22V11C16.5 10.4477 16.0523 10 15.5 10Z" fill="currentColor" />
              </svg>
            </i>
            <span class="item-name">Food Service</span>
            <i class="right-icon">
              <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
              </svg>
          ...
          <ul class="sub-nav collapse" id="food-service-menu" data-bs-parent="#sidebar-menu">
            <li class="nav-item">
              <a class="nav-link {{ Request::is('food-services') ? 'active' : ''}}" href="{{ route('food-services.index') }}">
                <i class="bi bi-list-ul"></i>
                <span class="item-name">Manage Services</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('food-service-claim') ? 'active' : ''}}" href="{{ route('food-service.claim-interface') }}">
                <i class="bi bi-upc-scan"></i>
                <span class="item-name">Claiming Interface</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ Request::is('food-service-reports') ? 'active' : ''}}" href="{{ route('food-service.reports') }}">
                <i class="bi bi-bar-chart-line"></i>
                <span class="item-name">Reports</span>
              </a>
            </li>
          </ul>
          <a class="nav-link" data-bs-toggle="collapse" href="#attendance-menu" role="button" aria-expanded="false" aria-controls="attendance-menu">
            <i class="icon">
              <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 11H15M9 15H15M21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3H7M17 3H19C20.1046 3 21 3.89543 21 5M17 3V5M17 3H13M7 3H5C3.89543 3 3 3.89543 3 5M7 3V5M7 3H11M11 1V5M13 1V5" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
              </svg>
            </i>
          ...
          <ul class="sub-nav collapse" id="attendance-menu" data-bs-parent="#attendance-menu">
            <li class="nav-item">
              <a class="nav-link {{ Request::segment(2) == 'attendance' ? 'active' : ''}}" href="{{ url('attendance') }}">
                <i class="bi bi-people-fill"></i>
                <span class="item-name">Manage {{__('messages.Attendance')}}</span>
              </a>
            </li>
            <li class="nav-item">
    ...
    <div class="position-relative iq-banner">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link" id="notification-drop" data-bs-toggle="dropdown">
                  <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle cx="17" cy="17" r="5" fill="#32CD32" stroke="white" stroke-width="2" />@endif
                  </svg>
                        ...
                        <div class="d-flex align-items-center">
                          <table class="m-0 table table-bordered table-sm">
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <center><span class="badge rounded-pill bg-primary"><?php if (file_exists(base_path("vbeta.json"))) {
                                ...
                                <td>
                                  <center><span class="badge rounded-pill bg-primary"><?php echo external_file_get_contents("https://beta.linkstack.org/vbeta.json"); ?></span></center>
                                </td>
                              </tr>
                            </tbody>
                          </table>
      ...
      <div class="iq-navbar-header header-block mb-2" style="height: 205px;">
        ...
        <div style="z-index:0!important;" class="iq-header-img">
          ...
          <!-- <img src="{{$headerImage}}" width="1920" height="400" loading="lazy" draggable="false" alt="header" class="img-fluid animated-scaleX">
                <img src="{{$headerImage}}" width="1920" height="400" draggable="false" alt="header" class="theme-color-purple-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{$headerImage}}" width="1920" height="400" draggable="false" alt="header" class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{$headerImage}}" width="1920" height="400" draggable="false" alt="header" class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{$headerImage}}" width="1920" height="400" draggable="false" alt="header" class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX">
                <img src="{{$headerImage}}" width="1920" height="400" draggable="false" alt="header" class="theme-color-pink-img img-fluid w-100 h-100 animated-scaleX"> -->
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="grid-cols-5 mb-4 d-grid gap-x-2">
            ...
            <div class="btn btn-border bg-transparent" data-value="theme-color-red active" data-info="#366AF0" data-setting="color-mode1" data-name="color" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Theme-3">
              <svg class="customizer-btn icon-32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32">
