                    ...
                    <div style="position: relative; top: 50%; transform: translateY(-50%);">
                      <h2 align="center" style="color:white">{{__('messages.Result')}}</h2>
                        ...
                        @endif
                          ...
                          @csrf
                          <div class="form-group col-lg-8">
                          <h2 style="font-size: 25px;">{{__('messages.Custom Icon')}} (Use Short Code provided in Details or use custom icons <a href="https://fontawesome.com/search?o=r&m=free" target="_blank">here</a>)</h2>
                          ...
                          <tr>
                            ...
                            <tr>
                              ...
                              <td><p>fa-solid fa-house</p></td>
                            </tr>
                            <tr>
                              <td>Solid</td>
                              <td></td>
                              <td><i class="fa-solid fa-globe"></i></td>
                              <td><p>fa-solid fa-globe</p></td>
                            </tr>
                            <tr>
