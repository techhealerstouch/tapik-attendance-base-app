                    ...
                    <div></div>
                        <div class="form-group col-lg-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="title" value="{{ $profinfo->title ?? '' }}" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="company" value="{{ $profinfo->company ?? '' }}" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="location" value="{{ $profinfo->location ?? '' }}" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="country" value="{{ $profinfo->country ?? '' }}" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="email" value="{{ $profinfo->email ?? '' }}" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="mobile" value="{{ $profinfo->mobile ?? '' }}" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="role" value="{{ $profinfo->role }}" required>
                            </div>
