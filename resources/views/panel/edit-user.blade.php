                          ...
                          @csrf
                            ...
                            <label>{{__('messages.Select theme')}}</label>
                              ...
                              <div class="form-group col-lg-8">
                                ...
                                <input type="text" class="form-control" name="rfid_no" value="{{ $user->rfid_no }}">
                              </div>
                              <div class="form-group col-lg-8">
                                <label>Code</label>
                                <input disabled type="text" class="form-control" name="name" value="{{ $user->activate_code }}">
                              </div>
                              <div class="form-group col-lg-8">
                                <label>Code Status</label>
                                <input disabled type="text" class="form-control" name="name" value="{{ $user->activate_status }}">
                              </div>
