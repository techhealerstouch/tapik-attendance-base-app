...
<head>
    ...
    <meta property="og:description"
        content='@if ($message->home_message == 'default') {!! strip_tags(__('messages.HOME.MESSAGE')) !!}@else{!! $message->home_message !!} @endif'>
            ...
            <div class="row m-0 align-items-center bg-white vh-100 vw-100">
                ...
                <div class="card card-transparent auth-card shadow-none d-flex mb-0">
                    ...
                    <div class="card-body justify-content-center text-center">
                        ...
                        @if (file_exists(base_path('assets/linkstack/images/') . findFile('avatar')))
                            <img alt="avatar" src="{{ asset('assets/linkstack/images/' . findFile('avatar')) }}"
                                width="auto" height="128px">
                        @else
                            <div class="logo-container fadein">

                                <img src="{{ asset('assets/linkstack/images/logo-animated.svg') }}" alt="Logo"
                        ...
                        <div class="d-flex justify-content-center align-items-center pt-4">
                            ...
                            @if (Route::has('login'))
                                ...
                                @else
                                    @if (Route::has('login'))
                                        <a class="btn btn-primary me-3"
                                            href="{{ route('login') }}">{{ __('messages.Log in') }}</a>
                                    @endif
